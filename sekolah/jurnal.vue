  ...
  module.exports = {
    ...
    methods: {
      get_jurnal : function(){
        ...
        if(this.find === ""){
          axios.get(
            base_url+"/jurnal-sekolah/"+this.formJurnal.id_sekolah+"/"+this.pagination.perPage+"/"+offset, conf
          )
          .then(response => {
          ...
          axios.post(
            base_url+"/jurnal-sekolah/find/"+this.formJurnal.id_sekolah+"/"+this.pagination.perPage+"/"+offset,
            form, conf)
          .then(response => {
            this.$bvToast.hide("loadingToast");
            this.jurnal = response.data.jurnal;
      ...
      authenticate : function(){
        if (!this.$cookies.isKey("Api-Token")) {
          ...
          .then(response => {
            this.formJurnal.id_sekolah = response.data.admin_sekolah.id_sekolah;
            this.get_jurnal();
          })
          .catch(error => {
            console.log(error);
